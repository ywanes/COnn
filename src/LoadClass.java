class LoadClass {
    ...
    public static Object getForce(String key, Exception e) throws Exception{
        ...
        if ( key.equals("KeyExchangeDHGEX") )
            return (Object)(new KeyExchangeDHGEX());
        if ( key.equals("KeyExchangeDHG1") )
            return (Object)(new KeyExchangeDHG1());
        if ( key.equals("KeyExchangeDHG14") )
            return (Object)(new KeyExchangeDHG14());
        if ( key.equals("KeyExchangeDHGEX256") )
            return (Object)(new KeyExchangeDHGEX256());
        if ( key.equals("SignatureECDSA256") )
            return (Object)(new SignatureECDSA256());
        if ( key.equals("SignatureECDSA384") )
            return (Object)(new SignatureECDSA384());
        if ( key.equals("SignatureECDSA521") )
            return (Object)(new SignatureECDSA521());
        if ( key.equals("KeyExchangeDHEC256") )
            return (Object)(new KeyExchangeDHEC256());
        if ( key.equals("KeyExchangeDHEC384") )
            return (Object)(new KeyExchangeDHEC384());
        if ( key.equals("KeyExchangeDHEC521") )
            return (Object)(new KeyExchangeDHEC521());
        if ( key.equals("KeyExchangeECDHN") )
            return (Object)(new KeyExchangeECDHN());
        if ( key.equals("KeyExchangeDH") )
            return (Object)(new KeyExchangeDH());
        if ( key.equals("CipherTripleDESCBC") )
            return (Object)(new CipherTripleDESCBC());
        if ( key.equals("BlowfishCBC") )
            return (Object)(new BlowfishCBC());
        if ( key.equals("HMACSHA1") )
            return (Object)(new HMACSHA1());
        if ( key.equals("HMACSHA196") )
            return (Object)(new HMACSHA196());
        if ( key.equals("HMACSHA256") )
            return (Object)(new HMACSHA256());
        if ( key.equals("HMACMD5") )
            return (Object)(new HMACMD5());
        if ( key.equals("HMACMD596") )
            return (Object)(new HMACMD596());
        if ( key.equals("HASHSHA1") )
            return (Object)(new HASHSHA1());
        if ( key.equals("HASHSHA256") )
            return (Object)(new HASHSHA256());
        if ( key.equals("HASHSHA384") )
            return (Object)(new HASHSHA384());
        if ( key.equals("HASHSHA512") )
            return (Object)(new HASHSHA512());
        if ( key.equals("HASHMD5") )
            return (Object)(new HASHMD5());
        if ( key.equals("SignatureDSA") )
            return (Object)(new SignatureDSA());
        if ( key.equals("SignatureRSA") )
            return (Object)(new SignatureRSA());
        if ( key.equals("KeyPairGenDSA") )
            return (Object)(new KeyPairGenDSA());
        if ( key.equals("KeyPairGenRSA") )
            return (Object)(new KeyPairGenRSA());
        if ( key.equals("KeyPairGenECDSA") )
            return (Object)(new KeyPairGenECDSA());
        if ( key.equals("Random") )
            return (Object)(new Random());
        if ( key.equals("CipherAES128CBC") )
            return (Object)(new CipherAES128CBC());
        if ( key.equals("CipherAES192CBC") )
            return (Object)(new CipherAES192CBC());
        if ( key.equals("CipherAES256CBC") )
            return (Object)(new CipherAES256CBC());
        if ( key.equals("CipherAES128CTR") )
            return (Object)(new CipherAES128CTR());
        if ( key.equals("CipherAES192CTR") )
            return (Object)(new CipherAES192CTR());
        if ( key.equals("CipherAES256CTR") )
            return (Object)(new CipherAES256CTR());
        if ( key.equals("CipherTripleDESCTR") )
            return (Object)(new CipherTripleDESCTR());
        if ( key.equals("CipherARCFOUR") )
            return (Object)(new CipherARCFOUR());
        if ( key.equals("CipherARCFOUR128") )
            return (Object)(new CipherARCFOUR128());
        if ( key.equals("CipherARCFOUR256") )
            return (Object)(new CipherARCFOUR256());
        if ( key.equals("UserAuthNone") )
            return (Object)(new UserAuthNone());
        if ( key.equals("UserAuthPassword") )
            return (Object)(new UserAuthPassword());
        if ( key.equals("UserAuthKeyboardInteractive") )
            return (Object)(new UserAuthKeyboardInteractive());
        if ( key.equals("UserAuthPublicKey") )
            return (Object)(new UserAuthPublicKey());
        if ( key.equals("UserAuthGSSAPIWithMIC") )
            return (Object)(new UserAuthGSSAPIWithMIC());
        if ( key.equals("GSSContextKrb5") )
            return (Object)(new GSSContextKrb5());
        if ( key.equals("Compression") )
            return (Object)(new Compression());
        if ( key.equals("Compression") )
            return (Object)(new Compression());
        if ( key.equals("PBKDF") )
            return (Object)(new PBKDF());        
